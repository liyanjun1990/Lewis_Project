...
#file_name = 'staff.DBF'
#file_path = fr"C:\Users\Account Payroll\Desktop\DATABASE\{file_name}"
#DBF(file_path).memofilename = "STAFF.BAK"

last_payrun_day = input("Payunrun Last Day: YYYY-MM-DD")
last_payrun_day = datetime.strptime(last_payrun_day,"%Y-%m-%d")

master_path = r'C:\Users\Accounting - 10102\OneDrive - PTC Phone Tech and Comm\Documents\GitHub\pythonProject\MYOBESAPI\\'

dis_path = master_path + "\PD_final.csv"
con_path = master_path + "\PC_final.csv"
tt_path = master_path + "TT_final.csv"
state_path = r"C:\Users\Accounting - 10102\OneDrive - PTC Phone Tech and Comm\Desktop\Payroll Data\COSTCENTER\STATE.csv"

out_path = r"C:\Users\Accounting - 10102\OneDrive - PTC Phone Tech and Comm\Desktop\Payroll Data\Result\\"

# dict_of_rate_path={
#  'SA':r"C:\Users\Account Payroll\Desktop\DATABASE\PTCSAREP\pay.DBF",
#  'TC':r"C:\Users\Account Payroll\Desktop\DATABASE\PTCTWEED\pay.DBF",
#  'WFT':r"C:\Users\Account Payroll\Desktop\DATABASE\PTCPROTE\pay.DBF",
#  'NQ':r'C:\Users\Account Payroll\Desktop\DATABASE\PTCNQREP\pay.DBF',
#  'PPA':r'C:\Users\Account Payroll\Desktop\DATABASE\PROTECPH\pay.DBF',
#  'IPA': r'C:\Users\Account Payroll\Desktop\DATABASE\IPROTECA\pay.DBF',
#  'CASE': r'C:\Users\Account Payroll\Desktop\DATABASE\CASECASE\pay.DBF',
# }

dict_of_rate_path={
 'SA':r"\\accounting-server\EXO\Payrollv\PTCSAREP\pay.DBF",
 'TC':r"\\accounting-server\EXO\Payrollv\PTCTWEED\pay.DBF",
 'WFT':r"\\accounting-server\EXO\Payrollv\PTCPROTE\pay.DBF",
 'NQ':r'\\accounting-server\EXO\Payrollv\PTCNQREP\pay.DBF',
 'PPA':r'\\accounting-server\EXO\Payrollv\PROTECPH\pay.DBF',
 'IPA': r'\\accounting-server\EXO\Payrollv\IPROTECA\pay.DBF',
 'CASE': r'\\accounting-server\EXO\Payrollv\CASECASE\pay.DBF',
}

# dict_of_staff_path={
#  'SA':r"C:\Users\Account Payroll\Desktop\DATABASE\PTCSAREP\staff.DBF",
#  'TC':r"C:\Users\Account Payroll\Desktop\DATABASE\PTCTWEED\staff.DBF",
#  'WFT':r"C:\Users\Account Payroll\Desktop\DATABASE\PTCPROTE\staff.DBF",
#  'NQ':r'C:\Users\Account Payroll\Desktop\DATABASE\PTCNQREP\staff.DBF',
#  'PPA':r'C:\Users\Account Payroll\Desktop\DATABASE\PROTECPH\staff.DBF',
#  'IPA': r'C:\Users\Account Payroll\Desktop\DATABASE\IPROTECA\staff.DBF',
#  'CASE': r'C:\Users\Account Payroll\Desktop\DATABASE\CASECASE\staff.DBF',
# }

dict_of_staff_path={
 'SA':r"\\accounting-server\EXO\Payrollv\PTCSAREP\staff.DBF",
 'TC':r"\\accounting-server\EXO\Payrollv\PTCTWEED\staff.DBF",
 'WFT':r"\\accounting-server\EXO\Payrollv\PTCPROTE\staff.DBF",
 'NQ':r'\\accounting-server\EXO\Payrollv\PTCNQREP\staff.DBF',
 'PPA':r'\\accounting-server\EXO\Payrollv\PROTECPH\staff.DBF',
 'IPA': r'\\accounting-server\EXO\Payrollv\IPROTECA\staff.DBF',
 'CASE': r'\\accounting-server\EXO\Payrollv\CASECASE\staff.DBF',
}

dict_of_leave_path={
 'SA':r"\\accounting-server\EXO\Payrollv\PTCSAREP\LEAVEENT.DBF",
 'TC':r"\\accounting-server\EXO\Payrollv\PTCTWEED\LEAVEENT.DBF",
 'WFT':r"\\accounting-server\EXO\Payrollv\PTCPROTE\LEAVEENT.DBF",
 'NQ':r'\\accounting-server\EXO\Payrollv\PTCNQREP\LEAVEENT.DBF',
 'PPA':r'\\accounting-server\EXO\Payrollv\PROTECPH\LEAVEENT.DBF',
 'IPA': r'\\accounting-server\EXO\Payrollv\IPROTECA\LEAVEENT.DBF',
 'CASE': r'\\accounting-server\EXO\Payrollv\CASECASE\LEAVEENT.DBF',
}

dict_of_cc={
 'SA':r"\\accounting-server\EXO\Payrollv\PTCSAREP\COSTCENT.DBF",
 'TC':r"\\accounting-server\EXO\Payrollv\PTCTWEED\COSTCENT.DBF",
 'WFT':r"\\accounting-server\EXO\Payrollv\PTCPROTE\COSTCENT.DBF",
 'NQ':r'\\accounting-server\EXO\Payrollv\PTCNQREP\COSTCENT.DBF',
 'PPA':r'\\accounting-server\EXO\Payrollv\PROTECPH\COSTCENT.DBF',
 'IPA': r'\\accounting-server\EXO\Payrollv\IPROTECA\COSTCENT.DBF',
 'CASE': r'\\accounting-server\EXO\Payrollv\CASECASE\COSTCENT.DBF',
}

dict_of_super={
'SA': r"\\accounting-server\EXO\Payrollv\PTCSAREP\PAYNCB.DBF",
'TC': r"\\accounting-server\EXO\Payrollv\PTCTWEED\PAYNCB.DBF",
'WFT': r"\\accounting-server\EXO\Payrollv\PTCPROTE\PAYNCB.DBF",
'NQ': r'\\accounting-server\EXO\Payrollv\PTCNQREP\PAYNCB.DBF',
'PPA': r'\\accounting-server\EXO\Payrollv\PROTECPH\PAYNCB.DBF',
'IPA': r'\\accounting-server\EXO\Payrollv\IPROTECA\PAYNCB.DBF',
'CASE': r'\\accounting-server\EXO\Payrollv\CASECASE\PAYNCB.DBF',
}
